...
export class Init1765087418024 implements MigrationInterface {
    name = 'Init1765087418024'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "episode" ("id" SERIAL NOT NULL, "itunesId" bigint, "title" character varying NOT NULL, "collectionName" character varying NOT NULL, "description" text, "image" character varying NOT NULL, "audioUrl" character varying NOT NULL, "releaseDate" character varying NOT NULL, "itunesCollectionId" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_7258b95d6d2bf7f621845a0e143" PRIMARY KEY ("id"))`);
